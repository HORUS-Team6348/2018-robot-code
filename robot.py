...
class Robot(wpilib.IterativeRobot):
    def robotInit(self):
        ...
        self.arm_encoder   = wpilib.Encoder(4, 5, False, wpilib.Encoder.EncodingType.k4X)
    ...
    def autonomousInit(self):
        ...
        """Manage autonomous routine override"""
    ...
    def teleopPeriodic(self):
        ...
        self.cube_arm.press(self.codriver_stick)
        self.climber.climb(self.codriver_stick)
